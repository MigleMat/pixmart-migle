...
export const copyImages = () =>
  src(paths.dev.modernImages, { since: lastRun(copyImages), encoding: false })
    .pipe(
      gulpif(
        args.debug,
        size({ ...sizeOptions, title: "Unotimised (modern raster): " })
      )
    )
    .pipe(
      sharpResponsive({
    ...
    .pipe(
      gulpif(
        args.debug,
        size({ ...sizeOptions, title: "Optimized (modern raster): " })
      )
    )
    .pipe(bs.stream());
...
export const optimizeVectorImages = () =>
  src(paths.dev.svgStatic)
    .pipe(
      gulpif(
        args.debug,
        size({ ...sizeOptions, title: "Unotimised (vector): " })
      )
    )
    .pipe(
      svgo({
    ...
    .pipe(
      gulpif(
        args.debug,
        size({ ...sizeOptions, title: "Optimised (vector): " })
      )
    )
    .pipe(bs.stream());
...
export const optimizeRasterImages = () =>
  src(paths.dev.images, { since: lastRun(images), encoding: false })
    .pipe(
      gulpif(
        args.debug,
        size({ ...sizeOptions, title: "Unotimised (raster): " })
      )
    )
    .pipe(
      sharpResponsive({
    ...
    .pipe(
      gulpif(
        args.debug,
        size({ ...sizeOptions, title: "Optimised (raster): " })
      )
    )
    .pipe(bs.stream());
